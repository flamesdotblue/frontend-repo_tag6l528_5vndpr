...
import { Stethoscope, MapPin, ShieldCheck, BadgeCheck } from 'lucide-react';
  ...
  return (
    <section className="relative bg-[#0B1220] text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Soft top/bottom gradient so text stays readable */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0B1220]/80 via-[#0B1220]/30 to-[#0B1220]/80" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-28 md:py-36">
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#book"
              className="inline-flex items-center gap-2 rounded-full bg-[#2BBCA2] px-6 py-3 font-semibold shadow-lg shadow-[#2BBCA2]/30 transition hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0B1220] focus:ring-[#2BBCA2]"
            >
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-sm">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 ring-1 ring-white/15">
              <ShieldCheck className="h-4 w-4 text-[#2BBCA2]" />
              <span>Certified by DOH</span>
            </div>
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 ring-1 ring-white/15">
              <BadgeCheck className="h-4 w-4 text-[#2BBCA2]" />
              <span>Serving since 1969</span>
            </div>
          </div>
        </div>
      </div>
